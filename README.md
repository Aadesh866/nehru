# Medusa Frontend Factory & Multi-Store Backend

This repository provides a complete headless architecture for running a "Frontend Factory" - allowing you to serve multiple different e-commerce storefronts (domains) from a single Medusa 2.0 backend and Next.js frontend.

## Deployment

Please read the **[Backend Deployment Guide](BACKEND_DEPLOYMENT_GUIDE.md)** for detailed instructions on deploying the Medusa and Payload CMS backend infrastructure to a server like Hetzner.
